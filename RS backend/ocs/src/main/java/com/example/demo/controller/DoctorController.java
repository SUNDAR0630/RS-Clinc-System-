...
public class DoctorController {
	...
	@GetMapping("/selectUser/{cid}/{password}")
	@ResponseBody
	public boolean auth(@PathVariable String cid,@PathVariable String password)
{

		System.out.println("Under Controller "+cid+" "+password);
