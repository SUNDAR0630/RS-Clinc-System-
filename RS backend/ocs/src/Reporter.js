...
function Reporter() {
  ...
  const handleSubmit=(e)=>{
   ...
   const obj={leaveID:leaveID,reporterID:reporterID,repoterName:reporterName,leaveForm:leaveFrom,leaveTo:leaveTo,reason:reason,status:status}
  console.log(obj)
  ...
  return (
    <div className="reporter-page">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button type="submit" style={{height: "50px" ,marginTop:"31px"}}>Submit</button>
      </form>
      <div className="reporter-page1">
  <button className="add-doctor-btn"> View All AvailableDoctors</button>
  <br></br>

  <button className="view-all-btn">IntimateAdmin</button>
</div>
